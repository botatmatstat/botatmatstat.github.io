...
переменной
    ...
    "answers": {
            ...
            `,
            "E": String.raw`
                Для любой оценки \(T\) из класса \(\mathcal{K}\) и любого \(\theta\)
выполнено \(\operatorname{E}((\hat\theta_n-\theta)^2)\leq \operatorname{E}((T-\theta)^2)\)
            `,},
        "true": "E",
        "explanation": "",
    ...
    ,
    {
    "question": String.raw`По выборке из 100 наблюдений \(X_1,\ldots,X_{n}\), имеющей нормальное распределение с неизвестной дисперсией, был получен 95% доверительный интервал для математического ожидания \([16,24]\). Считая критическое значение t-статистики равным 2, несмещенная оценка дисперсии была равна`,
    "answers": {
    ...
    ,
    {
    "question": String.raw`Пусть \(X = (X_1, \, \ldots, \, X_n)\) — случайная выборка из равномерного распределения на отрезке \([0; \, \theta]\), где \(\theta > 0\) — неизвестный параметр. Состоятельной является оценка`,
    "answers": {
