questions = [
    ...
    "answers": {
        "A": String.raw`\[F_Y(y)=\begin{cases}\frac{1}{4}y^2,\;\text{если}y\in[0;2]\\ 0,\;\text{иначе}\end{cases}\]`,
        "B": String.raw`\[F_Y(y)=\begin{cases}0,\;y<0 \\ \frac{1}{4}y^2,\;y\in[0;2]\\ 1,\;y>2 \end{cases}\]`,
        "C": String.raw`\[F_Y(y)=\begin{cases}0,\;y<0 \\ y^2,\;y\in[0;2]\\ 0,\;y>2 \end{cases}\]`,
        "D": String.raw`\[F_Y(y)=\begin{cases}0,\;y<0 \\ \frac{1}{2}y^2,\;y\in[0;2]\\ 0,\;y>2 \end{cases}\]`,
        "E": String.raw`\[F_Y(y)=\begin{cases}y^2,\;\text{если}y\in[0;2]\\ 0,\;\text{иначе}\end{cases}\]`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "question": String.raw`Плотность величины \(\,X\,\)имеет вид \(\,f(x)=2x\,\) при \( 0 < x < 1 \) и 
    \( f(x) = 0 \)
    при остальных 
    \(\,x\,\).Условная плотность величины \(\,Y\,\)задаётся формулой 
   \( \,f_{Y|X}(y|x)=\begin{cases}
   \frac{1}{x} & \text{if} \,\, 0 < y \le x;\\ 0 &
   \text{else}
   \end{cases}.\)
   Совместная плотность величин \(\,X\,\)и \(\,Y\,\)равна`,
    "answers": {
        "A": String.raw`\(\,f(x,y)=\begin{cases}
        2 & \text{if} \,\, 0 < y \le x < 1\\ 
        0 & \text{else}
        \end{cases}\,\)`,
        "B": String.raw`\(\,f(x,y)=\begin{cases}
        2 &  \text{if} \,\, 0 < y < 1, 0 < x < 1\\
         0 & \text{else}
        \end{cases}\,\)`,
        "C": String.raw`\(\,f(x,y)=\begin{cases} 1 &  \text{if} \,\, 0< y \le x < 1 \\ 0 & \text{else}\end{cases}\,\)`,
        "D": String.raw`\(\,f(x,y)=\begin{cases}1/x,\text{if}\,\, 0 < y < 1, 0 < x < 1\\ 0 & \text{else}\end{cases}\,\)`,
        "E": String.raw`\(\,f(x,y)=\begin{cases}1/x,\text{if}\,\, 0 < y  \le x < 1 \\ 0 & \text{else}\end{cases}\,\)`,
    },
    "true": "A",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`вырожденное`,
        "B": String.raw`абсолютно непрерывное`,
        "C": String.raw`дискретное`,
        "D": String.raw`сингулярное`,
        "E": String.raw`нормальное`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "B": String.raw`\(\,e^{-5}\frac{5^{12}}{12!}\,\)`,
        "C": String.raw`\(\,{e}^{-12}\frac{12^5}{5!}\,\)`,
        "D": String.raw`\(\,\frac{5}{12}\,\)`,
        "E": String.raw`\(\,e^{-5}\,\)`,
    },
    "true": "C",
    "explanation": "",
    ...
    "answers": {
        "A": String.raw`\(\,f(x)=\begin{cases}1/5,x \in[-5;5]\\ 0,x\notin[-5;5]\end{cases}\,\)`,
        "B": String.raw`\(\,f(x)=\begin{cases}1/20,x \in[30;50]\\ 0,x\notin[30;50]\end{cases}\,\)`,
        "C": String.raw`\(\,f(x)=\begin{cases}1/50,x \in[30;50]\\ 0,x\notin[30;50]\end{cases}\,\)`,
        "D": String.raw`\(\,f(x)=\begin{cases}x/30,x \in[30;50]\\ 0,x\notin[30;50]\end{cases}\,\)`,
        "E": String.raw`\(\,f(x)=\begin{cases}1/30,x \in[30;50]\\ 0,x\notin[30;50]\end{cases}\,\)`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`она не убывает`,
        "B": String.raw`\(\,F_X(x)>0\,\)`,
        "C": String.raw`она не возрастает`,
        "D": String.raw`\(\,F_{X}(x)\,\)принимает любые значения на \(\,[0,+\infty)\,\)`,
        "E": String.raw`она возрастает`,
    },
    "true": "A",
    "explanation": "",
}, {
    "question": String.raw`Величины \(\,\xi_1\,\),\(\,\xi_2\,\),...~независимы и имеют таблицы распределения 
    $$\begin{pmatrix}
    x & -1 & 1 \\
    \text{P}(\xi_i = x) & 1/2 & 1/2 \\
    
    \end{pmatrix}$$
    Рассмотрим их сумму \(\,S_n=\xi_1+...+\xi_n\,\).
    Предел \(\,\lim_{n \to \infty}\operatorname{P}\Bigl(\frac{S_n-\operatorname{E}(S_n)}{\sqrt{\operatorname{D}(S_n)}}>2\Bigr)\,\)равен`,
    "answers": {
        "A": String.raw`\(\,1\,\)`,
        "B": String.raw`\(\,\int_{2}^{+\infty}\frac{1}{\sqrt{2\pi}}\,e^{-t^2/2}\,dt\,\)`,
        "C": String.raw`\(\,\int_{-\infty}^{2}\frac{1}{\sqrt{2\pi}}\,e^{-t^2/2}\,dt\,\)`,
        "D": String.raw`\(\,\int_{2}^{+\infty}e^{-t^2/2}\,dt\,\)`,
        "E": String.raw`\(\,0.5\,\)`,
    },
    "true": "B",
    "explanation": "",
    ...
    "answers": {
        ...
        "B": String.raw`имеет разрывы`,
        "C": String.raw`не определена`,
        "D": String.raw`строго возрастает`,
        "E": String.raw`непрерывна`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "question": String.raw`Совместная функция плотности пары случайных величин \(\,X\,\)и \(\,Y\,\)имеет вид 
    \[f(x,y)=\begin{cases}c(2x+y),\;\text{if}x\in[0;2],y\in[0;2]\\ 0,
    \;\text{else}\end{cases}\]Константа \(\,c\,\)равна`,
    "answers": {
        "A": String.raw`\(\,1/8\,\)`,
        "B": String.raw`\(\,8\,\)`,
        "C": String.raw`\(\,12\,\)`,
    ...
    "answers": {
        "A": String.raw`\(\,F_Y(x)\,\)`,
        "B": String.raw`\(\,(\operatorname{E}(X))^2\,\)и \(\,\operatorname{E}(X)\,\)`,
        "C": String.raw`\(\,\operatorname{E}(XY)\,\)и \(\,\operatorname{E}(Y)\,\)`,
        "D": String.raw`\(\,\operatorname{Cov}(X,Y)\,\)и \(\,\operatorname{D}(Y)\,\)`,
        "E": String.raw`\(\,\operatorname{E}(X^2)\,\)и \(\,\operatorname{E}(X)\,\)`,
    },
    "true": "E",
    "explanation": "",
}, {
    ...
    "question": String.raw`Cовместная функция плотности случайных величин \(\,X\,\)и \(\,Y\,\)имеет вид 
    \[f(x,y)=\begin{cases}\frac{1}{4}xy,\;\text{if}x\in[0;2],y\in[0;2]\\ 0,\;\text{else}\end{cases}\]Найдите вероятность \(\,\operatorname{P}(Y=X)\,\)`,
    "answers": {
        "A": String.raw`\(\,3/4\,\)`,
        "B": String.raw`\(\,1/4\,\)`,
        "C": String.raw`\(\,0\,\)`,
        "D": String.raw`\(\,1/2\,\)`,
        "E": String.raw`невозможно вычислить на основе имеющихся данных`,
    },
    "true": "C",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "B": String.raw`\(\,A\,\)и \(\,B\,\);\(\,A\,\)и \(\,C\,\)`,
        "C": String.raw`только \(\,A\,\)и \(\,B\,\)`,
        "D": String.raw`\(\,A\,\)и \(\,C\,\);\(\,B\,\)и \(\,C\,\)`,
        "E": String.raw`только \(\,A\,\)и \(\,C\,\)`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`\(\,1\,\)`,
        "B": String.raw`\(\,\frac{1}{8}\,\)`,
        "C": String.raw`\(\,\frac{1}{2}\,\)`,
        "D": String.raw`\(\,2\,\)`,
        "E": String.raw`\(\,\frac{3}{4}\,\)`,
    },
    "true": "D",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`\(\,H(Y|X)+H(X|Y)=H(X,Y)\,\)`,
        "B": String.raw`\(\,H(X)\cdot H(Y)=H(X,Y)\,\)`,
        "C": String.raw`\(\,H(X\cdot Y)/H(X)=H(Y|X)\,\)`,
        "D": String.raw`\(\,H(X)+H(Y)=H(X,Y)\,\)`,
        "E": String.raw`\(\,H(Y|X)+H(X)=H(X,Y)\,\)`,
    },
    "true": "E",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`\(\,C_5^3 \left(\frac{7}{12}\right)^3 \left(\frac{5}{12}\right)^2\,\)`,
        "B": String.raw`\(\,\frac{3}{5}\cdot \frac{7}{12}\,\)`,
        "C": String.raw`\(\,\frac{C_5^3 C_7^2+C_5^4 C_7^1+C_5^5 C_7^0}{C_{12}^5}\,\)`,
        "D": String.raw`\(\,\frac{C_7^3 C_5^2+C_7^4 C_5^1+C_7^5 C_5^0}{C_{12}^5}\,\)`,
        "E": String.raw`\(\,C_5^3\left(\frac{7}{12}\right)^2\left(\frac{5}{12}\right)^3\,\)`,
    },
    "true": "D",
    "explanation": "",
}, {
