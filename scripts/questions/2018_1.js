questions = [{
    ...
    "answers": {
        "A": String.raw`\(\,\hat \theta_n \stackrel{P}{\to}\theta\,\)при;\(\,n\stackrel{}{\to}\infty\,\)`,
        "B": String.raw`\(\,\operatorname{D}(\hat \theta_n)=(\theta)^2/n\,\)`,
        "C": String.raw`\(\,\operatorname{E}(\hat \theta_n)=\theta\,\)`,
        "D": String.raw`\(\,\operatorname{E}((\hat \theta_n-\theta)^2)\stackrel{}{\to}0\,\)при;\(\,n\stackrel{}{\to}\infty\,\)`,
    ...
    "question": String.raw`Требуется проверить гипотезу о равенстве математических ожиданий по двум нормальным независимым выборкам размером 33 и 16 наблюдений.Истинные дисперсии по обеим выборкам известны,совпадают и равны 196.Разница выборочных средних равна 1.Тестовая статистика может быть примерно равна`,
    "answers": {
        "A": String.raw`\(\,-0.52\,\)`,
        "B": String.raw`\(\,0.11\,\)`,
        "C": String.raw`\(\,1.25\,\)`,
    ...
    "answers": {
        "A": String.raw`равно \(\,0.25\,\)`,
        "B": String.raw`равно \(\,0.5\,\)`,
        "C": String.raw`равно \(\,0\,\)`,
        "D": String.raw`равно \(\,1\,\)`,
        "E": String.raw`Недостаточно данных для ответа`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "C": String.raw`\(\,\operatorname{E}((\hat \theta_n-\theta)^2)\leq \operatorname{E}((\tilde \theta-\theta)^2)\,\);для всех \(\,\tilde \theta \in K\,\)`,
        "D": String.raw`\(\,\operatorname{E}(\hat \theta_n)=\theta\,\)`,
        "E": String.raw`\(\,\hat \theta_n \stackrel{\operatorname{P}}{\to}\theta\,\)при;\(\,n\stackrel{}{\to}\infty\,\)`,
    },
    "true": "C",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`\(\,[1.04,4.96]\,\)`,
        "B": String.raw`\(\,[3.08,5.92]\,\)`,
        "C": String.raw`\(\,[-4.02,1,02]\,\)`,
        "D": String.raw`\(\,[1.54,5.46]\,\)`,
        "E": String.raw`\(\,[0.86,5.14]\,\)`,
    },
    "true": "A",
    "explanation": "",
}, {
