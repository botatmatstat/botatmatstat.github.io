questions = [{
    ...
    "answers": {
        "A": String.raw`равно \(\,0\,\)`,
        "B": String.raw`равно \(\,1\,\)`,
        "C": String.raw`равно \(\,0.5\,\)`,
        "D": String.raw`Недостаточно данных для ответа`,
        "E": String.raw`равно \(\,0.25\,\)`,
    },
    "true": "C",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`\(\,\operatorname{E}((\hat \theta_n-\theta)^2)\stackrel{}{\to}0\,\operatorname{if}\,n\stackrel{}{\to}\infty\,\)`,
        "B": String.raw`\(\,\operatorname{E}((\hat \theta_n-\theta)^2)\leq \operatorname{E}((\tilde \theta-\theta)^2)\,\forall \,\tilde \theta \in K\,\)`,
        "C": String.raw`\(\,\operatorname{E}(\hat \theta_n)=\theta\,\)`,
        "D": String.raw`\(\,\hat \theta_n \stackrel{P}{\to}\theta\,\operatorname{if}\,n\stackrel{}{\to}\infty\,\)`,
        "E": String.raw`\(\,\operatorname{D}(\hat \theta_n)=(\theta)^2/n\,\)`,
    },
    "true": "D",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "B": String.raw`\(\,[-4.02,1,02]\,\)`,
        "C": String.raw`\(\,[0.86,5.14]\,\)`,
        "D": String.raw`\(\,[1.54,5.46]\,\)`,
        "E": String.raw`\(\,[3.08,5.92]\,\)`,
    },
    "true": "A",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "B": String.raw`\(\,F_{29,19}\,\)`,
        "C": String.raw`\(\,t_{48}\,\)`,
        "D": String.raw`\(\,\chi^2_{48}\,\)`,
        "E": String.raw`\(\,F_{20,30}\,\)`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "B": String.raw`\(\,\operatorname{E}((\hat \theta_n-\theta)^2)\leq \operatorname{E}((\tilde \theta-\theta)^2)\,\forall\,\tilde \theta \in K\,\)`,
        "C": String.raw`\(\,\hat \theta_n \stackrel{\operatorname{P}}{\to}\theta\,\operatorname{if}\,n\stackrel{}{\to}\infty\,\)`,
        "D": String.raw`\(\,\operatorname{D}(\hat \theta_n)=(\theta)^2/n\,\)`,
    ...
    "answers": {
        "A": String.raw`\(\,\tfrac{2}{3}\bar{X}\,\)`,
        "B": String.raw`\(\,\tfrac{3}{2}\bar{X}\,\)`,
        "C": String.raw`\(\,\sqrt{\sum_{i=1}^{n}X_i^2}\,\)`,
        "D": String.raw`\(\,\sqrt{\tfrac{2}{n}\sum_{i=1}^{n}X_i^2}\,\)`,
        "E": String.raw`\(\,\sqrt{\tfrac{n}{2}\sum_{i=1}^{n}X_i^2}\,\)`,
    },
    "true": "D",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "D": String.raw`\(\,\chi^2_1\,\)`,
        "E": String.raw`\(\,\chi^2_{99}\,\)`,
    },
    "true": "C",
    "explanation": "",
}, {
    ...
    "answers": {
        ...
        "C": String.raw`отвергается на уровне значимости 1%,но не отвергается на 5%`,
        "D": String.raw`отвергается на любом возможном уровне значимости`,
        "E": String.raw`не отвергается на любом возможном уровне значимости`,
    },
    "true": "B",
    "explanation": "",
}, {
    ...
    "answers": {
        "A": String.raw`\(\,N(2,\,9)\,\)`,
        "B": String.raw`\(\,N(2,\,1/30)\,\)`,
        "C": String.raw`\(\,N(2,\,1/3)\,\)`,
        "D": String.raw`\(\,N(2,\,1/9)\,\)`,
        "E": String.raw`\(\,N(2,\,1/900)\,\)`,
    },
    "true": "E",
    "explanation": "",
}, ]