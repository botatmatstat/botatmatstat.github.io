questions = [{
    ...
    "answers": {
            ...
            "A": String.raw`
                \(\operatorname{E}(Y|X=x)\geq \operatorname{E}(Y)\)
            `,
            "B": String.raw`
                \(\operatorname{Corr}(X,Y)\ne0\)
            `,
            "C": String.raw`
                \(\operatorname{E}(Y|X=x)\leq \operatorname{E}(Y)\)
            `,
            "D": String.raw`
                \(\operatorname{D}(Y|X=x)\geq \operatorname{D}(Y)\)
            `,
            "E": String.raw`
                \(\operatorname{D}(Y|X=x)\leq \operatorname{D}(Y)\)
            `,},
        "true": "E",
        "explanation": "",
    ...
    "answers": {
            ...
            "A": String.raw`
                \(\operatorname{D}(XY)=\operatorname{Cov}(X,Y)\)
            `,
            "B": String.raw`
                \(\operatorname{Corr}(X,Y)=-1\)
            `,
            "C": String.raw`
                \(\operatorname{P}(X>Y)=\operatorname{P}(Y>X)\)
            `,
            "D": String.raw`
                \(\operatorname{Corr}(X,Y)=1\)
            `,
            "E": String.raw`
                \(\operatorname{E}(XY)=10\)
            `,},
        "true": "E",
        "explanation": "",
